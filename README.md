...
Obs.: Para quem é experiente em desenvolvimento para NES, ainda não foi implementado vram buffer. A renderização ocorre diretamente, por isso pode haver bugs de renderização por conta do v blank.
